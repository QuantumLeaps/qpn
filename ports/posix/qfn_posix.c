...
pthread_cond_t QF_condVar_;  /* POSIX cond var to signal when AOs are ready */
...
#endif
        pthread_cond_signal(&QF_condVar_);        /* unblock the event loop */
    }
    QF_INT_ENABLE();
}
/*..........................................................................*/
...
int16_t QF_run(void) {
    ...
    pthread_cond_init(&QF_condVar_, 0);
    ...
    while (l_running) {             /* the event loop of the vanilla kernel */
        ...
        if (QF_readySet_ != (uint8_t)0) {
            ...
            pthread_cond_wait(&QF_condVar_, &QF_pThreadMutex_);
            QF_INT_ENABLE();
        }
    }
