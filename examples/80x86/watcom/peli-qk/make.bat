@echo off
:: ===========================================================================
:: PELICAN crossing example, 80x86, QK-nano port, Open Watcom compiler
...
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\pelican.obj  %SRCDIR%\pelican.c
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\ped.obj      %SRCDIR%\ped.c
