...
void BSP_onKeyboardInputISR(uint8_t key) {
    switch (key) {
        case 24: {                                  /* 'o': Alarm on event? */
            QActive_postISR((QActive *)&AO_AlarmClock, ALARM_ON_SIG, 0);
            break;
        }
        case 33: {                                 /* 'f': Alarm off event? */
            QActive_postISR((QActive *)&AO_AlarmClock, ALARM_OFF_SIG, 0);
            break;
        }
        case  2:                                                     /* '1' */
        case  3:                                                     /* '2' */
        ...
        case  9:                                                     /* '8' */
        case 10: {                                                   /* '9' */
            QActive_postISR((QActive *)&AO_AlarmClock, ALARM_SET_SIG, key -1);
            break;
        }
        case 11: {                                                   /* '0' */
            QActive_postISR((QActive *)&AO_AlarmClock, ALARM_SET_SIG, 0);
            break;
        }
        case 30: {                                 /* 'a': Clock 12H event? */
            QActive_postISR((QActive *)&AO_AlarmClock, CLOCK_12H_SIG, 0);
            break;
        }
        case 48: {                                 /* 'b': Clock 24H event? */
            QActive_postISR((QActive *)&AO_AlarmClock, CLOCK_24H_SIG, 0);
            break;
        }
        case 129: {                                         /* ESC pressed? */
            QActive_postISR((QActive *)&AO_AlarmClock, TERMINATE_SIG, 0);
            break;
        }
    }
}
