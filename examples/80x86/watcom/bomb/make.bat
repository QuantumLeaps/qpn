@echo off
:: ===========================================================================
:: Time Bomb example, 80x86, Vanilla port, Open Watcom compiler
...
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\oper.obj     %SRCDIR%\oper.c
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\bomb.obj     %SRCDIR%\bomb.c
