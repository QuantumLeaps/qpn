/*****************************************************************************
* Product: PELICAN crossing example, M16C/RSKM16C26A board, Vanilla kernel
...
void BSP_init(void) {
    ...
    prcr = 0x04;                     /* enables next instruction to set PD9 */
    pd9  = 0x03;                          /* set LCD control pins to output */
    pd6 |= 0x0F;         /* set data = outputs (M16C allows reading of ddr) */
