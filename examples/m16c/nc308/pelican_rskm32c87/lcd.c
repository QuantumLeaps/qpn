...
User Includes
***********************************************************************************/
/* sfr32C87.h provides a structure to access all of the device registers. */
#include "sfr32C87.h"
/* rskM32C87def.h provides common defines for widely used items. */
#include "rskM32C87def.h"
#include "lcd.h"
