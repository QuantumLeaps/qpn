...
//
//*****************************************************************************
//#define g_ucColumnAdjust 36U
#define g_ucColumnAdjust 4U
...
//
//*****************************************************************************
static uint32_t g_ulDelay;
void SysCtlDelay(uint32_t ulCount);


//*****************************************************************************
void
SysCtlDelay(uint32_t ulCount) {
    uint32_t volatile count;
    for (count = ulCount; count != 0U; --count) {
    }
}
...
//*****************************************************************************
void
Display96x16x1StringDraw(char const *pcStr, uint32_t ulX, uint32_t ulY)
{
...
//*****************************************************************************
void
Display96x16x1ImageDraw(uint8_t const *pucImage, uint32_t ulX,
