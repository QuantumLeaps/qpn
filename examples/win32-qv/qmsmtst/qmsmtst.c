...
/* private state histories */
    QMState const *his_s1;
} QMsmTst;

/* protected: */
static QState QMsmTst_initial(QMsmTst * const me);
static QState QMsmTst_s  (QMsmTst * const me);
...
static QState QMsmTst_s1  (QMsmTst * const me);
...
static QState QMsmTst_s11  (QMsmTst * const me);
...
static QState QMsmTst_s2  (QMsmTst * const me);
...
static QState QMsmTst_s21  (QMsmTst * const me);
...
static QState QMsmTst_s211  (QMsmTst * const me);
...
static QState QMsmTst_initial(QMsmTst * const me) {
    ...
    /* ${HSMs::QMsmTst::SM::initial} */
    me->foo = 0U;
    BSP_display("top-INIT;");
    /* state history attributes */
    me->his_s1 = &QMsmTst_s11_s;
...
static QState QMsmTst_s1_x(QMsmTst * const me) {
    BSP_display("s1-EXIT;");
    me->his_s1 = QMsm_stateObj(me); /* save history */
    return QM_EXIT(&QMsmTst_s1_s);
}
/* ${HSMs::QMsmTst::SM::s::s1::initial} */
static QState QMsmTst_s1_i(QMsmTst * const me) {
    static struct {
        QMState const *target;
...
static QState QMsmTst_s1(QMsmTst * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /* ${HSMs::QMsmTst::SM::s::s1::I} */
        case I_SIG: {
            BSP_display("s1-I;");
            status_ = QM_HANDLED();
            break;
        }
        /* ${HSMs::QMsmTst::SM::s::s1::D} */
        case D_SIG: {
            /* ${HSMs::QMsmTst::SM::s::s1::D::[!me->foo]} */
            if (!me->foo) {
                static struct {
                    QMState const *target;
                    QActionHandler act[3];
...
static QState QMsmTst_s11(QMsmTst * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /* ${HSMs::QMsmTst::SM::s::s1::s11::D} */
        case D_SIG: {
            /* ${HSMs::QMsmTst::SM::s::s1::s11::D::[me->foo]} */
            if (me->foo) {
                static struct {
                    QMState const *target;
                    QActionHandler act[3];
...
static QState QMsmTst_s2(QMsmTst * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /* ${HSMs::QMsmTst::SM::s::s2::I} */
        case I_SIG: {
            /* ${HSMs::QMsmTst::SM::s::s2::I::[!me->foo]} */
            if (!me->foo) {
                me->foo = 1U;
                BSP_display("s2-I;");
                status_ = QM_HANDLED();
        ...
        case F_SIG: {
            ...
            BSP_display("s2-F;");
            status_ = QM_TRAN_HIST(me->his_s1, &tatbl_);
            break;
        }
        /* ${HSMs::QMsmTst::SM::s::s2::C} */
        case C_SIG: {
            static struct {
                QMState const *target;
                QActionHandler act[4];
...
/* ${HSMs::QMsmTst::SM::s::s2::s21::initial} */
static QState QMsmTst_s21_i(QMsmTst * const me) {
    static struct {
        QMState const *target;
        QActionHandler act[2];
...
static QState QMsmTst_s211(QMsmTst * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /* ${HSMs::QMsmTst::SM::s::s2::s21::s211::H} */
        case H_SIG: {
            static struct {
                QMState const *target;
                QActionHandler act[5];
        ...
        /* ${HSMs::QMsmTst::SM::s::s2::s21::s211::D} */
        case D_SIG: {
            static struct {
                QMState const *target;
                QActionHandler act[3];
