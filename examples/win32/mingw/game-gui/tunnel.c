...
/* private: */
static void Tunnel_advance(Tunnel * const me);static void Tunnel_plantMine(Tunnel * const me);static void Tunnel_addImageAt(
    Tunnel * const me,
    uint8_t bmp,
    uint8_t x_pos,
    int8_t y_pos);static void Tunnel_dispatchToAllMines(Tunnel * const me, QSignal sig, QParam par);static uint8_t Tunnel_isWallHit(
    Tunnel * const me,
    uint8_t bmp,
    uint8_t x_pos,
    uint8_t y_pos);
