...
variable QPN is defined and it points to the location of the
QP-nano framework. For example, assuming that you have installed
QP-nano into the directory C:\qp\qpn, you should define the
environment variable QPN to C:\qp\qpn.
