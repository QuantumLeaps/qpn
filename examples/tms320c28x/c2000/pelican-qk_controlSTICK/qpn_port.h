/*****************************************************************************
* Product: PELICAN crossing example, for TMS320C2802x, with QK-nano
...
/*#define QF_ISR_NEST*/                    /* interrupt nesting NOT allowed */
...
*
* The TMS320C28x could support interrupt nesting and prioritization (as
* described in the Texas Instruments Application Note "Software Prioritized
* Interrupts").
*
* NOTE02:
