/*****************************************************************************
* Product: BSP for PELICAN crossing, PICCOLO controlSTICK, QK-nano
...
#include "DSP2802x_SWPrioritizedIsrLevels.h"    /* interrupt prioritization */
...
#else
    uint16_t volatile tempPIEIER;
    QK_ISR_ENTRY(tempPIEIER, 1, 7);       /* inform QK-nano about ISR entry */
#endif

    QF_tick();                            /* handle the QF-nano time events */

#ifndef QF_ISR_NEST
    QK_ISR_EXIT();                         /* inform QK-nano about ISR exit */
#else
    QK_ISR_EXIT(tempPIEIER, 1);            /* inform QK-nano about ISR exit */
#endif
}
/*..........................................................................*/
...
void BSP_init(void) {
    ...
    EDIS;
     ...
     /* explicitly initialize the QF-nano and QK-nano variables, see NOTE01 */
