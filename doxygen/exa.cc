...
<ul class="tag">
  ...
  <ul class="tag">
    ...
    <ul class="tag">
      ...
      <li><span class="img folder">dpp</span> &mdash; DPP example for Win32-QV (console app)</li>
      <li><span class="img folder">dpp-gui</span> &mdash; DPP example for Win32-QV (GUI app)</li>
