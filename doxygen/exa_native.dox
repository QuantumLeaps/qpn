...
<p>The QP-nano framework contains real-time kernels (@ref comp_qv and @ref comp_qk), so it can run natively ("bare-metal") on single-chip microcontrollers, completely replacing a traditional RTOS. The following ready-to-use, native (bare-metal) examples are provided for QP-nano:
</p>
...
- @subpage exa_arm-cm (Cortex-M0/M0+/M3/M4F)
    ...
    - @ref arm-cm_pelican_ek-tm4c123gxl <a class="preview board" href="bd_EK-TM4C123GXL.jpg" title="EK-TM4C123GXL"></a>
...
The native (bare-metal) QP-nano examples for ARM Cortex-M are as follows:
...
- @subpage arm-cm_pelican_ek-tm4c123gxl <a class="preview board" href="bd_EK-TM4C123GXL.jpg" title="EK-TM4C123GXL"></a>
*/
/*##########################################################################*/
...
*/
/*##########################################################################*/
/*! @page arm-cm_pelican_ek-tm4c123gxl PELICAN on EK-TM4C123GXL

@image html bd_EK-TM4C123GXL.jpg EK-TM4C123GXL board

PEdestrian LIght CONtrolled (PELICAN) Crossing example for Texas Instruments TivaC123GXL MCU (Cortex-M4F), ARM (MDK-ARM), GNU-ARM, IAR EWARM toolsets.

@image html pelican_win32.png PELICAN Crossing emulation running in a Windows console 
@n
@n
@image html under_construction.jpg
*/
