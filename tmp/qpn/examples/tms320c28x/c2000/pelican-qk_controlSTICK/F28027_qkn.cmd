...
// Checkin $Date: September 24, 2008   11:38:15 $
//###########################################################################
//
// FILE:	F28027.cmd
//
...
/* PRAMM0      : origin = 0x000000, length = 0x000400 */  /* on-chip RAM block M0 */
   PRAMM1      : origin = 0x000400, length = 0x000400     /* on-chip RAM block M1 */
   OTP         : origin = 0x3D7800, length = 0x000400     /* on-chip OTP */
   FLASH       : origin = 0x3F0000, length = 0x007F80     /* on-chip FLASH sectors A, B, C, D */
   CSM_RSVD    : origin = 0x3F7F80, length = 0x000076     /* Part of FLASHA.  Program with all 0x0000 when CSM is in use. */
   BEGIN       : origin = 0x3F7FF6, length = 0x000002     /* Part of FLASHA.  Used for "boot to Flash" bootloader mode. */
   CSM_PWL_PROG: origin = 0x3F7FF8, length = 0x000008     /* Part of FLASHA.  CSM password locations in FLASH */
...
/* RAMM1       : origin = 0x000400, length = 0x000400 */  /* on-chip RAM block M1 */
   DRAML0      : origin = 0x008000, length = 0x001000     /* on-chip RAM block L0 */  
}
